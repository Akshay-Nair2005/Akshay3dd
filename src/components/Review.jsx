...
const Review = () => {
    ...
    const [newReview, setNewReview] = useState({ title: "", author: "", content: "" });
    ...
    const toggleCommentBox = (index) => {
        const updatedReviews = [...reviews];
        updatedReviews[index].showCommentBox = !updatedReviews[index].showCommentBox;
        setReviews(updatedReviews);
    };
    ...
    return (
        <div className="min-h-screen mt-4 w-full">
            ...
            <div className=" mt-4 flex flex-wrap w-full justify-evenly">
                ...
                {/* Review List Section */}
                <div className="w-1/2 review-container overflow-y-auto h-[calc(100vh-100px)] mt-4 space-y-6 border-l border-[#D0605A]">
                    {reviews.map((review, index) => (
                        ...
                        >
                            ...
                            <div className="mt-4">
                                <button
                                    className={`mr-2 px-3 py-2 rounded-lg text-button  ${review.likeActive
                                        ? "bg-button"
                                        : "border border-[#F87871] text-[#F87871]"
                                        }`}
                                ...
                                <button
                                    className={`mr-2 px-3 py-2 rounded-lg  text-button ${review.dislikeActive
                                        ? "bg-button"
                                        : "border border-[#F87871] text-[#F87871]"
                                        }`}
                                ...
                                <button
                                    className="ml-2 px-3 py-2 rounded-lg border border-[#F87871] bg-[#121212] text-button"
